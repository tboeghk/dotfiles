# Generated by Powerlevel10k configuration wizard on 2020-05-25 at 14:10 CEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_SHOW_ON_COMMAND='kubectl|helm|kubens|kubectx|oc|istioctl|kogito|tf|terraform|k9s|popeye'
  ...
  typeset -g POWERLEVEL9K_GCLOUD_SHOW_ON_COMMAND='gcloud|gcs|tf|terraform|k9s|popeye|kubectl'
   # Google cloud color.
