# Generated by Powerlevel10k configuration wizard on 2020-02-18 at 09:33 CET.
...
() {
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_SHOW_ON_COMMAND='kubectl|helm|kubens|kubectx|oc|tf|terraform|k9s|popeye'
  ...
  typeset -g POWERLEVEL9K_AWS_SHOW_ON_COMMAND='aws|awless|terraform|pulumi|tf|terraform|k9s|popeye|kubectl'
  ...
  #typeset -g POWERLEVEL9K_AZURE_SHOW_ON_COMMAND='az|terraform|pulumi|tf'
  ...
  #typeset -g POWERLEVEL9K_GCLOUD_SHOW_ON_COMMAND='gcloud|gcs|tf|terraform'
  # Google cloud color.
  ...
  typeset -g POWERLEVEL9K_GOOGLE_APP_CRED_SHOW_ON_COMMAND='terraform|pulumi|tf|terraform|k9s|popeye|kubectl'
